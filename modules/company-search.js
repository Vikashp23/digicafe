  ...
  if (results.length === 0) {
    container.innerHTML = `
      <div class="glass" style="padding:2rem;text-align:center;color:var(--txt3)">
        ...
        <p>No match found. Try a different name, state, or registration number — or <a href="#" onclick="showPage('digital');return false" style="color:var(--blue2)">get in touch</a> if you'd like your company added to our client directory.</p>
      </div>
    `;
    return;
  }
